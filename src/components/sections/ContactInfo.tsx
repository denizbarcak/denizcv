...
const ContactInfo = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      link: 'https://github.com/denizbarcak'
    },
  ];
            ...
            {contactMethods.map((method, index) => (
              ...
              >
                <div className="flex items-center space-x-3 md:space-x-4">
                  <div className="w-9 h-9 md:w-12 md:h-12 rounded-lg bg-accent/10 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-primary transition-all duration-300">
                    {method.icon}
                  </div>
                  <div>
                    <h3 className="text-white font-medium text-base md:text-lg mb-1 group-hover:text-accent transition-colors duration-300">
                      {method.title}
                    </h3>
                    <p className="text-gray-400 text-sm md:text-base group-hover:text-white transition-colors duration-300">
                      {method.value}
                    </p>
                  </div>
                </div>
