          ...
          <div className="grid gap-8 md:grid-cols-2">
            {contactMethods.map((method, index) => (
              <motion.a
                ...
                className="p-6 bg-secondary rounded-lg transition-all duration-300 group hover:shadow-xl hover:shadow-accent/10"
              >
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 rounded-lg bg-accent/10 flex items-center justify-center text-accent group-hover:bg-accent group-hover:text-primary transition-all duration-300">
                    {method.icon}
                  </div>
                  <div>
                    <h3 className="text-white font-medium text-lg mb-1 group-hover:text-accent transition-colors duration-300">
                      {method.title}
                    </h3>
